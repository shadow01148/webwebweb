<script lang="ts">
	...
	import srvicon from '$lib/assets/img/hero-img.png';
...
<div class="card lg:card-side bg-base-100 h-96 shadow-xl">
	<div class="card-body">
		<h1 class="font-extrabold text-5xl h-16 text-center">Secure, flexible and reliable</h1><h1  class="font-extrabold text-transparent bg-clip-text text-5xl h-16 text-center bg-gradient-to-r from-green-200 via-green-300 to-blue-500">Yeet Hosting.</h1>
